...
## Seconds one dig takes before hardness/skill scaling. DigAction multiplies
## by the target material's hardness, then divides by the actor's mining skill
## multiplier (same seam HarvestAction uses for harvesting).
