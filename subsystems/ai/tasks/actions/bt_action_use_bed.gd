...
var _ceiling_seconds: float = 0.0
...
func _enter() -> void:
	...
	_component = null
	_params = null
	_min_session_seconds = 0.0
	_ceiling_seconds = 0.0
...
func _is_session_complete() -> bool:
	...
	if _elapsed < _min_session_seconds:
		return false
	return _read_need() >= 1.0 or _elapsed >= _ceiling_seconds
