---
title: Game Design Document — Xeno Frontier: Colony Defense
tags: [gdd, design, godot]
area: Projects
created: 2026-06-19
updated: 2026-09-10
status: DRAFT
version: v2.7 (scrap punk & alien invasion theme pivot)
---

# Xeno Frontier: Colony Defense — Game Design Document
...
> The stock template targets a mobile/Android action game. Xeno Frontier: Colony Defense is a PC 3D voxel colony survival sim. The following adaptations were made:
...
| Field | Value |
| --- | --- |
| **Game title** | Xeno Frontier: Colony Defense |
| **Genre** | Scrap punk voxel colony survival & horde defense (salvaged tech / alien invasion theme) |
...
| **One-sentence description** | Xeno Frontier: Colony Defense is a survival colony-sim & horde defense game where you lead a scrap-punk wasteland colony, fortifying with salvaged traps and improvised defenses by day and holding off regular alien invader assaults by night. |
| **Core fantasy** | The wasteland survivor-commander: constructing scrap metal fortifications and improvised traps in a buildable voxel world, managing colonist logistics and ammunition economy, holding the line against regular, massive alien horde waves sent crashing into the colony stronghold. |

**Theme notes:** Scrap punk / alien invasion wasteland. Sent or surviving on a desolate post-contact frontier. Technology is purely scrap-punk (salvaged metal, repurposed machinery, junk tech, blackpowder/ballistics — no magic). Threat is massive regular horde waves of alien invaders testing the colony's defensive perimeter.
...
- **Visual style:** Scrap punk / salvaged junk technology assets on a voxel block grid (repurposed steel, rusted scrap, salvaged wiring, masonry, timber). Theme is improvised post-apocalyptic frontier defense against alien invaders. MVP uses purchased asset bundles as **placeholder-final**: good enough to ship, replaced only where clearly wrong.
...
- **Notes:** Character/animation assets follow the MakeHuman/Mixamo pipeline (see `docs/HOWTO-use-makehuman-mixamo.md`); current character models live in `assets/makehuman/` and shared animations in `assets/mixamo/`. Enemies are **alien invaders / xeno threats** — Brawler/Shooter read as melee/ranged alien swarms attacking in regular high-volume horde waves.
...
| 2026-09-04 | **Turrets Early Implementation & Tactical Markers Spec:** Defensive turrets pulled forward from post-MVP into active development in alignment with the horde-defense stronghold loop. Turrets operate via Furniture capability (`TurretParams`), targeting closest enemies and consuming ammo from colony storage. Sensor markers (configurable radius) and target markers specced as a planned automation feature for predictive AOE/explosive bombardment. | Deepens tower defense tactical gameplay and provides concrete sinks for crafted ammunition types. |
| 2026-09-10 | **Theme Pivot to Scrap Punk & Alien Invaders:** Setting updated to Scrap Punk with Alien Invaders as the primary threat. Technology aesthetics refocused on scrap metal, salvaged machinery, and improvised defenses against alien swarm incursions. | Aligns game identity with player vision for scrap-punk survival aesthetics and xeno horde defense dynamics. |
...
- **Theme / alien lore detail** — confirmed scrap-punk wasteland setting with alien invader swarm threats; deeper lore (alien origins, wasteland factions) is in development and will inform the post-MVP art pass.
