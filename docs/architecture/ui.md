...
| `dig_box_hud/dig_box_hud.tscn` | Scene | Passive overlay on HUDLayer (CanvasLayer 10) displayed in `Mode.DIG_BOX_DESIGNATION`. Shows controls guide and live box dimensions ($W \times H \times D$). |
