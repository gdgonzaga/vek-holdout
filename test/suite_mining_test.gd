...
##   TerrainMaterialDef.yields on the default ground material
## - DigAction._apply: carve at the given center/radius + yields to the actor's
##   inventory + mining XP (the HarvestAction._apply testing seam)
